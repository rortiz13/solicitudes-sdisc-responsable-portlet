...
/**
 * The persistence utility for the parametros service. This utility wraps {@link ParametrosPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ParametrosUtil {
	 ...
	 */
	public static void clearCache(Parametros parametros) {
		getPersistence().clearCache(parametros);
	}
	 ...
	 */
	public static List<Parametros> findWithDynamicQuery(
	 ...
	 */
	public static Parametros update(Parametros parametros, boolean merge)
		throws SystemException {
		return getPersistence().update(parametros, merge);
	}
	...
	public static Parametros update(Parametros parametros, boolean merge,
		...
		return getPersistence().update(parametros, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(parametroses);
	}
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Parametros create(
		int id) {
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Parametros remove(
		int id)
	...
	public static la.netco.solicitudes_sdisc.model.model.Parametros updateImpl(
		la.netco.solicitudes_sdisc.model.model.Parametros parametros,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(parametros, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.solicitudes_sdisc.model.model.Parametros findByPrimaryKey(
		int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			la.netco.solicitudes_sdisc.model.NoSuchParametrosException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.solicitudes_sdisc.model.model.Parametros fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<la.netco.solicitudes_sdisc.model.model.Parametros> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ParametrosPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ParametrosPersistence)PortletBeanLocatorUtil.locate(la.netco.solicitudes_sdisc.model.service.ClpSerializer.getServletContextName(),
					ParametrosPersistence.class.getName());

			ReferenceRegistry.registerReference(ParametrosUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(ParametrosPersistence persistence) {
	}

	private static ParametrosPersistence _persistence;
}