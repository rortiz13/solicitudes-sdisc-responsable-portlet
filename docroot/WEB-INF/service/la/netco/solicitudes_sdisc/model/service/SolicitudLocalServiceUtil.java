...
/**
 * The utility for the Solicitud local service. This utility wraps {@link la.netco.solicitudes_sdisc.model.service.impl.SolicitudLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see la.netco.solicitudes_sdisc.model.service.impl.SolicitudLocalServiceImpl
 * @generated
 */
public class SolicitudLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link la.netco.solicitudes_sdisc.model.service.impl.SolicitudLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud addSolicitud(
		la.netco.solicitudes_sdisc.model.model.Solicitud solicitud)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addSolicitud(solicitud);
	}
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud createSolicitud(
		int id_solicitud) {
		return getService().createSolicitud(id_solicitud);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud deleteSolicitud(
		int id_solicitud)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSolicitud(id_solicitud);
	}
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud deleteSolicitud(
		la.netco.solicitudes_sdisc.model.model.Solicitud solicitud)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSolicitud(solicitud);
	}
	...
	*/
	...
	public static la.netco.solicitudes_sdisc.model.model.Solicitud fetchSolicitud(
		int id_solicitud)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchSolicitud(id_solicitud);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud getSolicitud(
		int id_solicitud)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSolicitud(id_solicitud);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<la.netco.solicitudes_sdisc.model.model.Solicitud> getSolicituds(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSolicituds(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSolicitudsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSolicitudsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud updateSolicitud(
		la.netco.solicitudes_sdisc.model.model.Solicitud solicitud)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSolicitud(solicitud);
	}
	...
	*/
	public static la.netco.solicitudes_sdisc.model.model.Solicitud updateSolicitud(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSolicitud(solicitud, merge);
	}
	...
	*/
	...
	public static SolicitudLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SolicitudLocalService.class.getName());

			if (invokableLocalService instanceof SolicitudLocalService) {
				_service = (SolicitudLocalService)invokableLocalService;
			}
			else {
				_service = new SolicitudLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SolicitudLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(SolicitudLocalService service) {
	}

	private static SolicitudLocalService _service;
}