 ...
 * @author smontanez
 */
public class SolicitudLocalServiceClp implements SolicitudLocalService {
	public SolicitudLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud addSolicitud(
		...
		return (la.netco.solicitudes_sdisc.model.model.Solicitud)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud createSolicitud(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { id_solicitud });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud deleteSolicitud(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { id_solicitud });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud fetchSolicitud(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { id_solicitud });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud getSolicitud(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { id_solicitud });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.solicitudes_sdisc.model.model.Solicitud> getSolicituds(
		...
		return (java.util.List<la.netco.solicitudes_sdisc.model.model.Solicitud>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.solicitudes_sdisc.model.model.Solicitud updateSolicitud(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(solicitud), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.solicitudes_sdisc.model.model.Solicitud> findByFields(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] {
						ClpSerializer.translateInput(fechaIni),
						
					ClpSerializer.translateInput(fechaFin),
						
					ClpSerializer.translateInput(id_ciudad_solicitante),
						
					ClpSerializer.translateInput(id_perfil),
						
					ClpSerializer.translateInput(id_estado),
