 ...
 * @author smontanez
 */
public class EstadoLocalServiceClp implements EstadoLocalService {
	public EstadoLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public la.netco.solicitudes_sdisc.model.model.Estado addEstado(
		...
		return (la.netco.solicitudes_sdisc.model.model.Estado)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.solicitudes_sdisc.model.model.Estado createEstado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { id_estado });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Estado deleteEstado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { id_estado });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Estado fetchEstado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { id_estado });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Estado getEstado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { id_estado });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.solicitudes_sdisc.model.model.Estado> getEstados(
		...
		return (java.util.List<la.netco.solicitudes_sdisc.model.model.Estado>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.solicitudes_sdisc.model.model.Estado updateEstado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(estado), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.solicitudes_sdisc.model.model.Estado findByNombre(
		...
		try {
			...
			if (t instanceof la.netco.solicitudes_sdisc.model.NoSuchEstadoException) {
				throw (la.netco.solicitudes_sdisc.model.NoSuchEstadoException)t;
			}
