...
/**
 * The base implementation of the Solicitud local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.solicitudes_sdisc.model.service.impl.SolicitudLocalServiceImpl}.
 * </p>
 *
 * @author smontanez
 ...
 * @generated
 */
public abstract class SolicitudLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SolicitudLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.solicitudes_sdisc.model.service.SolicitudLocalServiceUtil} to access the Solicitud local service.
	 */
	...
	public Solicitud addSolicitud(Solicitud solicitud)
		...
		return solicitudPersistence.update(solicitud, false);
	}
	 ...
	 */
	public Solicitud createSolicitud(int id_solicitud) {
		return solicitudPersistence.create(id_solicitud);
	}
	...
	public Solicitud deleteSolicitud(int id_solicitud)
		throws PortalException, SystemException {
		return solicitudPersistence.remove(id_solicitud);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Solicitud deleteSolicitud(Solicitud solicitud)
		throws SystemException {
		return solicitudPersistence.remove(solicitud);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Solicitud.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return solicitudPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return solicitudPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return solicitudPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Solicitud fetchSolicitud(int id_solicitud) throws SystemException {
		return solicitudPersistence.fetchByPrimaryKey(id_solicitud);
	}
	...
	public Solicitud getSolicitud(int id_solicitud)
		throws PortalException, SystemException {
		return solicitudPersistence.findByPrimaryKey(id_solicitud);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return solicitudPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Solicitud> getSolicituds(int start, int end)
		throws SystemException {
		return solicitudPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSolicitudsCount() throws SystemException {
		return solicitudPersistence.countAll();
	}
	...
	public Solicitud updateSolicitud(Solicitud solicitud)
		throws SystemException {
		return updateSolicitud(solicitud, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Solicitud updateSolicitud(Solicitud solicitud, boolean merge)
		throws SystemException {
		solicitud.setNew(false);

		return solicitudPersistence.update(solicitud, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.solicitudes_sdisc.model.model.Solicitud",
			solicitudLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = solicitudPersistence.getDataSource();
	...
	private SolicitudLocalServiceClpInvoker _clpInvoker = new SolicitudLocalServiceClpInvoker();
}